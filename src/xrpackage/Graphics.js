...
const gls = [window.WebGLRenderingContext, window.WebGL2RenderingContext].map((WebGLRenderingContext, index) => {
  ...
  function ProxiedWebGLRenderingContext(canvas) {
    Object.defineProperty(this, 'canvas', {
      // Object.defineProperty to avoid proxying
      get() {
        return canvas;
      },
    });
  ...
  ProxiedWebGLRenderingContext.prototype._exokitBlendFuncSeparate = function _exokitBlendFuncSeparate(
    srcRgb,
    dstRgb,
    srcAlpha,
    dstAlpha
  ...
  ProxiedWebGLRenderingContext.prototype.getExtension = ((_getExtension) =>
  ...
  ProxiedWebGLRenderingContext.prototype.setProxyState = function setProxyState() {
    ...
    if (gl.binding !== this) {
      ...
      setKeyValue(
        ...
        gl.bindRenderbuffer,
        gl.RENDERBUFFER,
        state.renderbuffer[gl.RENDERBUFFER],
        state2.renderbuffer[gl.RENDERBUFFER]
      );
      if (hasWebGL2) {
        setKeyValue(
          gl,
          gl.bindFramebuffer,
          gl.READ_FRAMEBUFFER,
          state.framebuffer[gl.READ_FRAMEBUFFER],
          state2.framebuffer[gl.READ_FRAMEBUFFER]
        );
        setKeyValue(
          gl,
          gl.bindFramebuffer,
          gl.DRAW_FRAMEBUFFER,
          state.framebuffer[gl.DRAW_FRAMEBUFFER],
          state2.framebuffer[gl.DRAW_FRAMEBUFFER]
        );
      } else {
        setKeyValue(
          gl,
          gl.bindFramebuffer,
          gl.FRAMEBUFFER,
          state.framebuffer[gl.FRAMEBUFFER],
          state2.framebuffer[gl.FRAMEBUFFER]
        );
      }
      ...
      setKeyValue(
        ...
        state2.unpackColorspaceConversion
      );
  ...
  if (WebGLRenderingContext.prototype.bindVertexArray) {
    ProxiedWebGLRenderingContext.prototype.bindVertexArray = ((_bindVertexArray) =>
    ...
    ProxiedWebGLRenderingContext.prototype.deleteVertexArray = ((_deleteVertexArray) =>
  ...
  ProxiedWebGLRenderingContext.prototype.bindBuffer = ((_bindBuffer) =>
    function bindBuffer(target, b) {
      if (target === this.ARRAY_BUFFER) {
        this.state.arrayBuffer = b;
      }
      return _bindBuffer.apply(this, arguments);
    })(ProxiedWebGLRenderingContext.prototype.bindBuffer);
  ProxiedWebGLRenderingContext.prototype.deleteBuffer = ((_deleteBuffer) =>
  ...
  ProxiedWebGLRenderingContext.prototype.bindRenderbuffer = ((_bindRenderbuffer) =>
    function bindRenderbuffer(target, rbo) {
  ...
  ProxiedWebGLRenderingContext.prototype.deleteRenderbuffer = ((_deleteRenderbuffer) =>
    function deleteRenderbuffer(rbo) {
  ...
  ProxiedWebGLRenderingContext.prototype.bindFramebuffer = ((_bindFramebuffer) =>
  ...
  ProxiedWebGLRenderingContext.prototype.deleteFramebuffer = ((_deleteFramebuffer) =>
    function deleteFramebuffer(fbo) {
  ...
  ProxiedWebGLRenderingContext.prototype.enable = ((_enable) =>
  ...
  ProxiedWebGLRenderingContext.prototype.disable = ((_disable) =>
  ...
  ProxiedWebGLRenderingContext.prototype.activeTexture = ((_activeTexture) =>
  ...
  ProxiedWebGLRenderingContext.prototype.pixelStorei = ((_pixelStorei) =>
  ...
  ProxiedWebGLRenderingContext.prototype.useProgram = ((_useProgram) =>
  ...
  ProxiedWebGLRenderingContext.prototype.deleteProgram = ((_deleteProgram) =>
  ...
  ProxiedWebGLRenderingContext.prototype.viewport = ((_viewport) =>
  ...
  ProxiedWebGLRenderingContext.prototype.scissor = ((_scissor) =>
  ...
  ProxiedWebGLRenderingContext.prototype.blendFunc = ((_blendFunc) =>
    function blendFunc(blendSrc, blendDst) {
  ...
  ProxiedWebGLRenderingContext.prototype.blendFuncSeparate = ((_blendFuncSeparate) =>
    function blendFuncSeparate(blendSrcRgb, blendDstRgb, blendSrcAlpha, blendDstAlpha) {
  ...
  ProxiedWebGLRenderingContext.prototype.blendEquation = ((_blendEquation) =>
    function blendEquation(blendEquation) {
  ...
  ProxiedWebGLRenderingContext.prototype.blendEquationSeparate = ((_blendEquationSeparate) =>
    function blendEquationSeparate(blendEquationRgb, blendEquationAlpha) {
  ...
  ProxiedWebGLRenderingContext.prototype.blendColor = ((_blendColor) =>
  ...
  ProxiedWebGLRenderingContext.prototype.clearColor = ((_clearColor) =>
  ...
  ProxiedWebGLRenderingContext.prototype.colorMask = ((_colorMask) =>
  ...
  ProxiedWebGLRenderingContext.prototype.cullFace = ((_cullFace) =>
    function cullFace(cullFaceMode) {
      this.state.cullFaceMode = cullFaceMode;
      return _cullFace.apply(this, arguments);
    })(ProxiedWebGLRenderingContext.prototype.cullFace);
  ProxiedWebGLRenderingContext.prototype.clearDepth = ((_clearDepth) =>
    function clearDepth(depthClearValue) {
  ...
  ProxiedWebGLRenderingContext.prototype.depthFunc = ((_depthFunc) =>
    function depthFunc(df) {
      this.state.depthFunc = df;
      return _depthFunc.apply(this, arguments);
    })(ProxiedWebGLRenderingContext.prototype.depthFunc);
  ProxiedWebGLRenderingContext.prototype.depthRange = ((_depthRange) =>
  ...
  ProxiedWebGLRenderingContext.prototype.lineWidth = ((_lineWidth) =>
  ...
  ProxiedWebGLRenderingContext.prototype.polygonOffset = ((_polygonOffset) =>
    function polygonOffset(polygonOffsetFactor, polygonOffsetUnits) {
  ...
  ProxiedWebGLRenderingContext.prototype.sampleCoverage = ((_sampleCoverage) =>
    function sampleCoverage(sampleCoverageValue, sampleCoverageUnits) {
  ...
  ProxiedWebGLRenderingContext.prototype.stencilFunc = ((_stencilFunc) =>
  ...
  ProxiedWebGLRenderingContext.prototype.stencilFuncSeparate = ((_stencilFuncSeparate) =>
  ...
  ProxiedWebGLRenderingContext.prototype.stencilOp = ((_stencilOp) =>
  ...
  ProxiedWebGLRenderingContext.prototype.stencilOpSeparate = ((_stencilOpSeparate) =>
  ...
  ProxiedWebGLRenderingContext.prototype.stencilMask = ((_stencilMask) =>
    function stencilMask(face, mask) {
  ...
  ProxiedWebGLRenderingContext.prototype.stencilMaskSeparate = ((_stencilMaskSeparate) =>
  ...
  ProxiedWebGLRenderingContext.prototype.clearStencil = ((_clearStencil) =>
    function stencilClearValue(stencilClearValue) {
  ...
  ProxiedWebGLRenderingContext.prototype.bindTexture = ((_bindTexture) =>
  ...
  ProxiedWebGLRenderingContext.prototype.deleteTexture = ((_deleteTexture) =>
  ...
  if (hasWebGL2 && WebGLRenderingContext.name === 'WebGLRenderingContext') {
    ...
    ProxiedWebGLRenderingContext.prototype.createShader = ((_createShader) =>
      function createShader(type) {
        const result = _createShader.call(this, type);
        result.type = type;
        return result;
      })(ProxiedWebGLRenderingContext.prototype.createShader);
    ProxiedWebGLRenderingContext.prototype.shaderSource = ((_shaderSource) =>
    ...
    ProxiedWebGLRenderingContext.prototype.getActiveAttrib = ((_getActiveAttrib) =>
    ...
    ProxiedWebGLRenderingContext.prototype.getActiveUniform = ((_getActiveUniform) =>
    ...
    ProxiedWebGLRenderingContext.prototype.getAttribLocation = ((_getAttribLocation) =>
      function getAttribLocation(program, path) {
    ...
    ProxiedWebGLRenderingContext.prototype.getUniformLocation = ((_getUniformLocation) =>
      function getUniformLocation(program, path) {
        path = webGlToOpenGl.mapName(path);
...
const getContext = ((oldGetContext) =>
  function getContext(type, init = {}) {
      ...
      if (gl) {
        ...
        canvas.toBlob = function toBlob(cb, type, quality) {
          ...
          ctx2.drawImage(
            ...
            0,
            this.proxyContext.canvas.height - canvas2.height,
            canvas.width,
            canvas.height,
            0,
            0,
...
export { hijackCanvas, getExports };
