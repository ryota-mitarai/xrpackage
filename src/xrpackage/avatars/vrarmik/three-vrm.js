...
var __three_vrm__ = /******/ (function (modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  /******/ return __webpack_require__((__webpack_require__.s = './assign.ts'));
  /******/
})(
  /************************************************************************/
  /******/ {
  ...
  \***********************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        var __three_vrm__ = __webpack_require__(/*! . */ './index.ts');
  ...
  \**********************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        __export(__webpack_require__(/*! ./vrm/ */ './vrm/index.ts'));
  ...
  \************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        var disposer_1 = __webpack_require__(/*! ./utils/disposer */ './vrm/utils/disposer.ts');
        var VRMImporter_1 = __webpack_require__(/*! ./VRMImporter */ './vrm/VRMImporter.ts');
        var VRM = (function () {
          function VRM(params) {
  ...
  \********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        var blendshape_1 = __webpack_require__(/*! ./blendshape */ './vrm/blendshape/index.ts');
        var firstperson_1 = __webpack_require__(/*! ./firstperson */ './vrm/firstperson/index.ts');
        var VRMHumanoidImporter_1 = __webpack_require__(
          /*! ./humanoid/VRMHumanoidImporter */ './vrm/humanoid/VRMHumanoidImporter.ts'
        );
        var VRMLookAtImporter_1 = __webpack_require__(
          /*! ./lookat/VRMLookAtImporter */ './vrm/lookat/VRMLookAtImporter.ts'
        );
        var material_1 = __webpack_require__(/*! ./material */ './vrm/material/index.ts');
        var reduceBones_1 = __webpack_require__(/*! ./reduceBones */ './vrm/reduceBones.ts');
        var VRMSpringBoneImporter_1 = __webpack_require__(
          /*! ./springbone/VRMSpringBoneImporter */ './vrm/springbone/VRMSpringBoneImporter.ts'
        );
        var VRM_1 = __webpack_require__(/*! ./VRM */ './vrm/VRM.ts');
        var VRMImporter = (function () {
          function VRMImporter(options) {
            ...
            this._springBoneImporter =
              options.springBoneImporter || new VRMSpringBoneImporter_1.VRMSpringBoneImporter();
          }
    ...
    /***/ './vrm/blendshape/VRMBlendShapeGroup.ts':
      /*!**************************************************!*\
  !*** ./vrm/blendshape/VRMBlendShapeGroup.ts ***!
  \**************************************************/
      /*! no static exports found */
    ...
    /***/ './vrm/blendshape/VRMBlendShapeImporter.ts':
      /*!*****************************************************!*\
  !*** ./vrm/blendshape/VRMBlendShapeImporter.ts ***!
  \*****************************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        var types_1 = __webpack_require__(/*! ../types */ './vrm/types/index.ts');
        var renameMaterialProperty_1 = __webpack_require__(
          /*! ../utils/renameMaterialProperty */ './vrm/utils/renameMaterialProperty.ts'
        );
        var VRMBlendShapeGroup_1 = __webpack_require__(
          /*! ./VRMBlendShapeGroup */ './vrm/blendshape/VRMBlendShapeGroup.ts'
        );
        var VRMBlendShapeProxy_1 = __webpack_require__(
          /*! ./VRMBlendShapeProxy */ './vrm/blendshape/VRMBlendShapeProxy.ts'
        );
                ...
                switch (_a.label) {
                  case 0:
                    ...
                    return [
                      4,
                      Promise.all(
                        blendShapeGroups.map(function (schemaGroup) {
                                    ...
                                    return __generator(this, function (_a) {
                                      switch (_a.label) {
                                        ...
                                        case 1:
                                          morphMeshes = _a.sent();
                                          primitives =
                                            morphMeshes.type === 'Group' ? morphMeshes.children : [morphMeshes];
                                          morphTargetIndex = bind.index;
                                          if (
                                            !primitives.every(function (primitive) {
                                              return (
                                ...
                                materialValues.forEach(function (materialValue) {
                                  ...
                                  gltf.scene.traverse(function (object) {
                                    if (object.material) {
                                      ...
                                      if (Array.isArray(material)) {
                                        materials.push.apply(
                                          materials,
                                          material.filter(function (mtl) {
                                            return (
                                              mtl.name === materialValue.materialName && materials.indexOf(mtl) === -1
                                            );
                                          })
                                        );
                                      } else if (
                                  ...
                                  materials.forEach(function (material) {
                                    group.addMaterialValue({
                                      material: material,
                                      propertyName: renameMaterialProperty_1.renameMaterialProperty(
    ...
    /***/ './vrm/blendshape/VRMBlendShapeProxy.ts':
      /*!**************************************************!*\
  !*** ./vrm/blendshape/VRMBlendShapeProxy.ts ***!
  \**************************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        var math_1 = __webpack_require__(/*! ../utils/math */ './vrm/utils/math.ts');
  ...
  \*************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        __export(__webpack_require__(/*! ./VRMBlendShapeGroup */ './vrm/blendshape/VRMBlendShapeGroup.ts'));
        __export(__webpack_require__(/*! ./VRMBlendShapeImporter */ './vrm/blendshape/VRMBlendShapeImporter.ts'));
        __export(__webpack_require__(/*! ./VRMBlendShapeProxy */ './vrm/blendshape/VRMBlendShapeProxy.ts'));

        /***/
      },

    /***/ './vrm/debug/VRMDebug.ts':
      /*!***********************************!*\
  !*** ./vrm/debug/VRMDebug.ts ***!
  \***********************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        var THREE = __webpack_require__(/*! three */ 'three');
        var VRM_1 = __webpack_require__(/*! ../VRM */ './vrm/VRM.ts');
        var VRMImporterDebug_1 = __webpack_require__(/*! ./VRMImporterDebug */ './vrm/debug/VRMImporterDebug.ts');
  ...
  \*******************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var reduceBones_1 = __webpack_require__(/*! ../reduceBones */ './vrm/reduceBones.ts');
        var VRMImporter_1 = __webpack_require__(/*! ../VRMImporter */ './vrm/VRMImporter.ts');
        var VRMDebug_1 = __webpack_require__(/*! ./VRMDebug */ './vrm/debug/VRMDebug.ts');
        var VRMLookAtImporterDebug_1 = __webpack_require__(
          /*! ./VRMLookAtImporterDebug */ './vrm/debug/VRMLookAtImporterDebug.ts'
        );
        var VRMSpringBoneImporterDebug_1 = __webpack_require__(
          /*! ./VRMSpringBoneImporterDebug */ './vrm/debug/VRMSpringBoneImporterDebug.ts'
        );
        var VRMImporterDebug = (function (_super) {
          ...
          function VRMImporterDebug(options) {
            ...
            options.springBoneImporter =
              options.springBoneImporter || new VRMSpringBoneImporterDebug_1.VRMSpringBoneImporterDebug();
    ...
    /***/ './vrm/debug/VRMLookAtHeadDebug.ts':
      /*!*********************************************!*\
  !*** ./vrm/debug/VRMLookAtHeadDebug.ts ***!
  \*********************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        var THREE = __webpack_require__(/*! three */ 'three');
        var VRMLookAtHead_1 = __webpack_require__(/*! ../lookat/VRMLookAtHead */ './vrm/lookat/VRMLookAtHead.ts');
        var _v3 = new THREE.Vector3();
    ...
    /***/ './vrm/debug/VRMLookAtImporterDebug.ts':
      /*!*************************************************!*\
  !*** ./vrm/debug/VRMLookAtImporterDebug.ts ***!
  \*************************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        var VRMLookAtHeadDebug_1 = __webpack_require__(/*! ./VRMLookAtHeadDebug */ './vrm/debug/VRMLookAtHeadDebug.ts');
    ...
    /***/ './vrm/debug/VRMSpringBoneDebug.ts':
      /*!*********************************************!*\
  !*** ./vrm/debug/VRMSpringBoneDebug.ts ***!
  \*********************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        var THREE = __webpack_require__(/*! three */ 'three');
        var springbone_1 = __webpack_require__(/*! ../springbone */ './vrm/springbone/index.ts');
    ...
    /***/ './vrm/debug/VRMSpringBoneImporterDebug.ts':
      /*!*****************************************************!*\
  !*** ./vrm/debug/VRMSpringBoneImporterDebug.ts ***!
  \*****************************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        var VRMSpringBoneDebug_1 = __webpack_require__(/*! ./VRMSpringBoneDebug */ './vrm/debug/VRMSpringBoneDebug.ts');
        var VRMSpringBoneImporterDebug = (function (_super) {
          ...
          VRMSpringBoneImporterDebug.prototype._createSpringBone = function (
            gltf,
            bone,
            hitRadius,
            stiffiness,
            ...
            var springBone = new VRMSpringBoneDebug_1.VRMSpringBoneDebug(
              bone,
              hitRadius,
              stiffiness,
              gravityDir,
  ...
  \********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        __export(__webpack_require__(/*! ./VRMDebugOptions */ './vrm/debug/VRMDebugOptions.ts'));
        __export(__webpack_require__(/*! ./VRMDebug */ './vrm/debug/VRMDebug.ts'));
        __export(__webpack_require__(/*! ./VRMSpringBoneDebug */ './vrm/debug/VRMSpringBoneDebug.ts'));
        __export(__webpack_require__(/*! ./VRMSpringBoneImporterDebug */ './vrm/debug/VRMSpringBoneImporterDebug.ts'));

        /***/
      },

    /***/ './vrm/firstperson/VRMFirstPerson.ts':
      /*!***********************************************!*\
  !*** ./vrm/firstperson/VRMFirstPerson.ts ***!
  \***********************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        var VRMFirstPerson = (function () {
          ...
          VRMFirstPerson.prototype.getFirstPersonWorldDirection = function (target) {
            return target
              .copy(VECTOR3_FRONT)
              .applyQuaternion(math_1.getWorldQuaternionLite(this._firstPersonBone, _quat));
          };
    ...
    /***/ './vrm/firstperson/VRMFirstPersonImporter.ts':
      /*!*******************************************************!*\
  !*** ./vrm/firstperson/VRMFirstPersonImporter.ts ***!
  \*******************************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        var THREE = __webpack_require__(/*! three */ 'three');
        var types_1 = __webpack_require__(/*! ../types */ './vrm/types/index.ts');
        var VRMFirstPerson_1 = __webpack_require__(/*! ./VRMFirstPerson */ './vrm/firstperson/VRMFirstPerson.ts');
                  ...
                  case 4:
                    ...
                    meshes.forEach(function (mesh, meshIndex) {
                      var flag = schemaFirstPerson.meshAnnotations
                        ? schemaFirstPerson.meshAnnotations.find(function (a) {
                            return a.mesh === meshIndex;
                          })
                        : undefined;
                      meshAnnotations.push(
                        new VRMFirstPerson_1.VRMRendererFirstPersonFlags(flag && flag.firstPersonFlag, mesh)
                      );
                    });
                    return [
                      2,
                      new VRMFirstPerson_1.VRMFirstPerson(firstPersonBone, firstPersonBoneOffset, meshAnnotations),
                    ];
                }
              });
            });
  ...
  \**************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        __export(__webpack_require__(/*! ./VRMFirstPerson */ './vrm/firstperson/VRMFirstPerson.ts'));
        __export(__webpack_require__(/*! ./VRMFirstPersonImporter */ './vrm/firstperson/VRMFirstPersonImporter.ts'));

        /***/
      },

    /***/ './vrm/humanoid/VRMHumanBone.ts':
      /*!******************************************!*\
  !*** ./vrm/humanoid/VRMHumanBone.ts ***!
  \******************************************/
      /*! no static exports found */
  ...
  \*******************************************/
    ...
    /***/ './vrm/humanoid/VRMHumanDescription.ts':
      /*!*************************************************!*\
  !*** ./vrm/humanoid/VRMHumanDescription.ts ***!
  \*************************************************/
      /*! no static exports found */
  ...
  \*****************************************/
    ...
    /***/ './vrm/humanoid/VRMHumanoidImporter.ts':
      /*!*************************************************!*\
  !*** ./vrm/humanoid/VRMHumanoidImporter.ts ***!
  \*************************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        var THREE = __webpack_require__(/*! three */ 'three');
        var VRMHumanBone_1 = __webpack_require__(/*! ./VRMHumanBone */ './vrm/humanoid/VRMHumanBone.ts');
        var VRMHumanoid_1 = __webpack_require__(/*! ./VRMHumanoid */ './vrm/humanoid/VRMHumanoid.ts');
                ...
                switch (_a.label) {
                  case 0:
                    ...
                    return [
                      4,
                      Promise.all(
                        schemaHumanoid.humanBones.map(function (bone) {
                          return __awaiter(_this, void 0, void 0, function () {
                            var node;
                            return __generator(this, function (_a) {
                              switch (_a.label) {
                                ...
                                case 1:
                                  ...
                                  humanBoneArray.push({
                                    ...
                                    bone: new VRMHumanBone_1.VRMHumanBone(node, {
                                      ...
                                      center:
                                        bone.center && new THREE.Vector3(bone.center.x, bone.center.y, bone.center.z),
  ...
  \***********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        __export(__webpack_require__(/*! ./VRMHumanBone */ './vrm/humanoid/VRMHumanBone.ts'));
        __export(__webpack_require__(/*! ./VRMHumanBones */ './vrm/humanoid/VRMHumanBones.ts'));
        __export(__webpack_require__(/*! ./VRMHumanDescription */ './vrm/humanoid/VRMHumanDescription.ts'));
        __export(__webpack_require__(/*! ./VRMHumanLimit */ './vrm/humanoid/VRMHumanLimit.ts'));
        __export(__webpack_require__(/*! ./VRMHumanoid */ './vrm/humanoid/VRMHumanoid.ts'));
        __export(__webpack_require__(/*! ./VRMHumanoidImporter */ './vrm/humanoid/VRMHumanoidImporter.ts'));
  ...
  \**************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        __export(__webpack_require__(/*! ./VRM */ './vrm/VRM.ts'));
        __export(__webpack_require__(/*! ./VRMImporter */ './vrm/VRMImporter.ts'));
        __export(__webpack_require__(/*! ./reduceBones */ './vrm/reduceBones.ts'));
        __export(__webpack_require__(/*! ./blendshape */ './vrm/blendshape/index.ts'));
        __export(__webpack_require__(/*! ./debug */ './vrm/debug/index.ts'));
        __export(__webpack_require__(/*! ./firstperson */ './vrm/firstperson/index.ts'));
        __export(__webpack_require__(/*! ./humanoid */ './vrm/humanoid/index.ts'));
        __export(__webpack_require__(/*! ./lookat */ './vrm/lookat/index.ts'));
        __export(__webpack_require__(/*! ./springbone */ './vrm/springbone/index.ts'));
        __export(__webpack_require__(/*! ./types */ './vrm/types/index.ts'));
        __export(__webpack_require__(/*! ./material */ './vrm/material/index.ts'));

        /***/
      },

    /***/ './vrm/lookat/CurveMapper.ts':
      /*!***************************************!*\
  !*** ./vrm/lookat/CurveMapper.ts ***!
  \***************************************/
      /*! no static exports found */
    ...
    /***/ './vrm/lookat/VRMLookAtApplyer.ts':
      /*!********************************************!*\
  !*** ./vrm/lookat/VRMLookAtApplyer.ts ***!
  \********************************************/
      /*! no static exports found */
    ...
    /***/ './vrm/lookat/VRMLookAtBlendShapeApplyer.ts':
      /*!******************************************************!*\
  !*** ./vrm/lookat/VRMLookAtBlendShapeApplyer.ts ***!
  \******************************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        var types_1 = __webpack_require__(/*! ../types */ './vrm/types/index.ts');
        var VRMLookAtApplyer_1 = __webpack_require__(/*! ./VRMLookAtApplyer */ './vrm/lookat/VRMLookAtApplyer.ts');
    ...
    /***/ './vrm/lookat/VRMLookAtBoneApplyer.ts':
      /*!************************************************!*\
  !*** ./vrm/lookat/VRMLookAtBoneApplyer.ts ***!
  \************************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        var types_1 = __webpack_require__(/*! ../types */ './vrm/types/index.ts');
        var VRMLookAtApplyer_1 = __webpack_require__(/*! ./VRMLookAtApplyer */ './vrm/lookat/VRMLookAtApplyer.ts');
        var VRMLookAtHead_1 = __webpack_require__(/*! ./VRMLookAtHead */ './vrm/lookat/VRMLookAtHead.ts');
  ...
  \*****************************************/
    ...
    /***/ './vrm/lookat/VRMLookAtImporter.ts':
      /*!*********************************************!*\
  !*** ./vrm/lookat/VRMLookAtImporter.ts ***!
  \*********************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        var THREE = __webpack_require__(/*! three */ 'three');
        var types_1 = __webpack_require__(/*! ../types */ './vrm/types/index.ts');
        var CurveMapper_1 = __webpack_require__(/*! ./CurveMapper */ './vrm/lookat/CurveMapper.ts');
        var VRMLookAtBlendShapeApplyer_1 = __webpack_require__(
          /*! ./VRMLookAtBlendShapeApplyer */ './vrm/lookat/VRMLookAtBlendShapeApplyer.ts'
        );
        var VRMLookAtBoneApplyer_1 = __webpack_require__(
          /*! ./VRMLookAtBoneApplyer */ './vrm/lookat/VRMLookAtBoneApplyer.ts'
        );
        var VRMLookAtHead_1 = __webpack_require__(/*! ./VRMLookAtHead */ './vrm/lookat/VRMLookAtHead.ts');
        var VRMLookAtImporter = (function () {
            ...
            switch (schemaFirstPerson.lookAtTypeName) {
              case types_1.VRMSchema.FirstPersonLookAtTypeName.Bone: {
                if (
                  ...
                  return new VRMLookAtBoneApplyer_1.VRMLookAtBoneApplyer(
                    humanoid,
              ...
              case types_1.VRMSchema.FirstPersonLookAtTypeName.BlendShape: {
                if (
                  ...
                  return new VRMLookAtBlendShapeApplyer_1.VRMLookAtBlendShapeApplyer(
                    blendShapeProxy,
          ...
          VRMLookAtImporter.prototype._importCurveMapperBone = function (map) {
            return new CurveMapper_1.CurveMapper(
  ...
  \*********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        __export(__webpack_require__(/*! ./CurveMapper */ './vrm/lookat/CurveMapper.ts'));
        __export(__webpack_require__(/*! ./VRMLookAtApplyer */ './vrm/lookat/VRMLookAtApplyer.ts'));
        __export(__webpack_require__(/*! ./VRMLookAtBlendShapeApplyer */ './vrm/lookat/VRMLookAtBlendShapeApplyer.ts'));
        __export(__webpack_require__(/*! ./VRMLookAtBoneApplyer */ './vrm/lookat/VRMLookAtBoneApplyer.ts'));
        __export(__webpack_require__(/*! ./VRMLookAtHead */ './vrm/lookat/VRMLookAtHead.ts'));
        __export(__webpack_require__(/*! ./VRMLookAtImporter */ './vrm/lookat/VRMLookAtImporter.ts'));

        /***/
      },

    /***/ './vrm/material/MToonMaterial.ts':
      /*!*******************************************!*\
  !*** ./vrm/material/MToonMaterial.ts ***!
  \*******************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        var getTexelDecodingFunction_1 = __webpack_require__(
          /*! ./getTexelDecodingFunction */ './vrm/material/getTexelDecodingFunction.ts'
        );
        var mtoon_vert_1 = __webpack_require__(/*! ./shaders/mtoon.vert */ './vrm/material/shaders/mtoon.vert');
        var mtoon_frag_1 = __webpack_require__(/*! ./shaders/mtoon.frag */ './vrm/material/shaders/mtoon.frag');
        var TAU = 2.0 * Math.PI;
          ...
          MToonMaterial.prototype._updateShaderCode = function () {
            ...
            var encodings =
              (this.shadeTexture !== null
                ? getTexelDecodingFunction_1.getTexelDecodingFunction(
    ...
    /***/ './vrm/material/VRMMaterialImporter.ts':
      /*!*************************************************!*\
  !*** ./vrm/material/VRMMaterialImporter.ts ***!
  \*************************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        var THREE = __webpack_require__(/*! three */ 'three');
        var MToonMaterial_1 = __webpack_require__(/*! ./MToonMaterial */ './vrm/material/MToonMaterial.ts');
        var VRMUnlitMaterial_1 = __webpack_require__(/*! ./VRMUnlitMaterial */ './vrm/material/VRMUnlitMaterial.ts');
                ...
                switch (_a.label) {
                  ...
                  case 1:
                    ...
                    return [
                      4,
                      Promise.all(
                        meshesMap.map(function (mesh, meshIndex) {
                          return __awaiter(_this, void 0, void 0, function () {
                            var primitives;
                            var _this = this;
                            return __generator(this, function (_a) {
                              switch (_a.label) {
                                case 0:
                                  ...
                                  return [
                                    4,
                                    Promise.all(
                                      primitives.map(function (primitive, primitiveIndex) {
                                        return __awaiter(_this, void 0, void 0, function () {
                                          ...
                                          return __generator(this, function (_a) {
                                            switch (_a.label) {
                                              case 0:
                                                ...
                                                vrmMaterialIndex =
                                                  gltf.parser.json.meshes[meshIndex].primitives[primitiveIndex]
                                                    .material;
                                                props = materialProperties[vrmMaterialIndex];
                                                if (!props) {
                                                  console.warn(
                                                    'VRMMaterialImporter: There are no material definition for material #' +
                                                      vrmMaterialIndex +
                                                      ' on VRM extension.'
                                                  );
          ...
          VRMMaterialImporter.prototype._extractMaterialProperties = function (originalMaterial, vrmProps, gltf) {
            ...
            if (vrmProps.textureProperties) {
              var _loop_1 = function (name) {
                ...
                taskList.push(
                  gltf.parser.getDependency('texture', textureIndex).then(function (texture) {
            ...
            if (vrmProps.vectorProperties) {
              var _loop_2 = function (name) {
                ...
                ].some(function (textureName) {
                  return name === textureName;
                });
                if (isTextureST) {
                  newName += '_ST';
                }
                params[newName] = new ((_a = THREE.Vector4).bind.apply(
                  _a,
                  [void 0].concat(vrmProps.vectorProperties[name])
                ))();
              };
              var this_2 = this;
            ...
            if (
              vrmProps.keywordMap._ALPHATEST_ON &&
              params.blendMode === MToonMaterial_1.MToonMaterialRenderMode.Opaque
            ) {
    ...
    /***/ './vrm/material/VRMUnlitMaterial.ts':
      /*!**********************************************!*\
  !*** ./vrm/material/VRMUnlitMaterial.ts ***!
  \**********************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        var THREE = __webpack_require__(/*! three */ 'three');
        var unlit_vert_1 = __webpack_require__(/*! ./shaders/unlit.vert */ './vrm/material/shaders/unlit.vert');
        var unlit_frag_1 = __webpack_require__(/*! ./shaders/unlit.frag */ './vrm/material/shaders/unlit.frag');
        ...
        (function (VRMUnlitMaterialRenderType) {
          ...
          VRMUnlitMaterialRenderType[(VRMUnlitMaterialRenderType['TransparentWithZWrite'] = 3)] =
    ...
    /***/ './vrm/material/getTexelDecodingFunction.ts':
      /*!******************************************************!*\
  !*** ./vrm/material/getTexelDecodingFunction.ts ***!
  \******************************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.getTexelDecodingFunction = function (functionName, encoding) {
          ...
          return (
            'vec4 ' + functionName + '( vec4 value ) { return ' + components[0] + 'ToLinear' + components[1] + '; }'
          );
        };
  ...
  \***********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        __export(__webpack_require__(/*! ./MToonMaterial */ './vrm/material/MToonMaterial.ts'));
        __export(__webpack_require__(/*! ./VRMMaterialImporter */ './vrm/material/VRMMaterialImporter.ts'));
        __export(__webpack_require__(/*! ./VRMUnlitMaterial */ './vrm/material/VRMUnlitMaterial.ts'));

        /***/
      },

    /***/ './vrm/material/shaders/mtoon.frag':
      /*!*********************************************!*\
  !*** ./vrm/material/shaders/mtoon.frag ***!
  \*********************************************/
    ...
    /***/ './vrm/material/shaders/mtoon.vert':
      /*!*********************************************!*\
  !*** ./vrm/material/shaders/mtoon.vert ***!
  \*********************************************/
      /*! exports provided: default */
    ...
    /***/ './vrm/material/shaders/unlit.frag':
      /*!*********************************************!*\
  !*** ./vrm/material/shaders/unlit.frag ***!
  \*********************************************/
      /*! exports provided: default */
    ...
    /***/ './vrm/material/shaders/unlit.vert':
      /*!*********************************************!*\
  !*** ./vrm/material/shaders/unlit.vert ***!
  \*********************************************/
      /*! exports provided: default */
  ...
  \********************************/
    ...
    /***/ './vrm/springbone/VRMSpringBone.ts':
      /*!*********************************************!*\
  !*** ./vrm/springbone/VRMSpringBone.ts ***!
  \*********************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        var VRMSpringBone = (function () {
          ...
          VRMSpringBone.prototype.update = function (delta) {
            ...
            var initialWorldMatrixInv = _matA.getInverse(
              _matB.copy(this._getParentMatrixWorld()).multiply(this._initialLocalMatrix)
            );
            var applyRotation = _quatA.setFromUnitVectors(
              this._boneAxis,
              _v3A.copy(this._nextTail).applyMatrix4(initialWorldMatrixInv).normalize()
            );
    ...
    /***/ './vrm/springbone/VRMSpringBoneColliderGroup.ts':
      /*!**********************************************************!*\
  !*** ./vrm/springbone/VRMSpringBoneColliderGroup.ts ***!
  \**********************************************************/
      /*! no static exports found */
    ...
    /***/ './vrm/springbone/VRMSpringBoneImporter.ts':
      /*!*****************************************************!*\
  !*** ./vrm/springbone/VRMSpringBoneImporter.ts ***!
  \*****************************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        var THREE = __webpack_require__(/*! three */ 'three');
        var VRMSpringBone_1 = __webpack_require__(/*! ./VRMSpringBone */ './vrm/springbone/VRMSpringBone.ts');
        var VRMSpringBoneManager_1 = __webpack_require__(
          /*! ./VRMSpringBoneManager */ './vrm/springbone/VRMSpringBoneManager.ts'
        );
        var VRMSpringBoneImporter = (function () {
          ...
          VRMSpringBoneImporter.prototype._createSpringBone = function (
            gltf,
            bone,
            hitRadius,
            stiffiness,
            ...
            return new VRMSpringBone_1.VRMSpringBone(
              bone,
              hitRadius,
              stiffiness,
              gravityDir,
            ...
            return __awaiter(this, void 0, Promise, function () {
              ...
              return __generator(this, function (_a) {
                ...
                springBoneGroups.forEach(function (vrmBoneGroup) {
                  ...
                  var gravityDir = new THREE.Vector3(
                        ...
                        switch (_a.label) {
                          ...
                          case 1:
                            ...
                            springRootBone.traverse(function (bone) {
                              var springBone = _this._createSpringBone(
                                gltf,
                                bone,
                                hitRadius,
                                stiffiness,
                      ...
                      switch (_a.label) {
                        ...
                        case 1:
                          ...
                          colliderGroup.colliders.forEach(function (collider) {
                            ...
                            var offsetMatrix = new THREE.Matrix4().makeTranslation(
                              collider.offset.x,
                              collider.offset.y,
                              -collider.offset.z
                            );
                            var visible = _this._isColiderMeshVisible;
                            var colliderMesh = new THREE.Mesh(
    ...
    /***/ './vrm/springbone/VRMSpringBoneManager.ts':
      /*!****************************************************!*\
  !*** ./vrm/springbone/VRMSpringBoneManager.ts ***!
  \****************************************************/
      /*! no static exports found */
  ...
  \*************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        __export(__webpack_require__(/*! ./VRMSpringBone */ './vrm/springbone/VRMSpringBone.ts'));
        __export(
          __webpack_require__(/*! ./VRMSpringBoneColliderGroup */ './vrm/springbone/VRMSpringBoneColliderGroup.ts')
        );
        __export(__webpack_require__(/*! ./VRMSpringBoneImporter */ './vrm/springbone/VRMSpringBoneImporter.ts'));
        __export(__webpack_require__(/*! ./VRMSpringBoneManager */ './vrm/springbone/VRMSpringBoneManager.ts'));

        /***/
      },

    /***/ './vrm/types/GLTFSchema.ts':
      /*!*************************************!*\
  !*** ./vrm/types/GLTFSchema.ts ***!
  \*************************************/
      /*! no static exports found */
  ...
  \********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        __export(__webpack_require__(/*! ./GLTFSchema */ './vrm/types/GLTFSchema.ts'));
        __export(__webpack_require__(/*! ./VRMSchema */ './vrm/types/VRMSchema.ts'));
        __export(__webpack_require__(/*! ./types */ './vrm/types/types.ts'));
  ...
  \*******************************/
    ...
    /***/ './vrm/utils/renameMaterialProperty.ts':
      /*!*************************************************!*\
  !*** ./vrm/utils/renameMaterialProperty.ts ***!
  \*************************************************/
      /*! no static exports found */
